...
<body>
	...
	<div class="boton-directorio">
		<?php

			echo "<a class='link' href='http://ti.tpitic.com.mx/INFRAESTRUCTURA-PRODUCCION/Infraestructura/informe/index.php?666U2lzdGVtYXM=897'><button class='directorio'>Regresar</button></a>";
