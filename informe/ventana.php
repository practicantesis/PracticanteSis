...
<body>
	<center>
		...
		if ($con) {
			...
			echo '<thead class="encabezado"><tr><td>TAG</td><td>Usuario</td><td>Numero celular</td><td>Oficina</td><td>Marca</td><td>IMEI</td><td>Departamento</td></tr></thead>';
			...
			for ($i = 0; $i < $count; $i++) {
				...
				echo '<td>' . $info[$i]['devicedept'][0] . '</td></tr></tbody>';
				...
				$buscarwatch = $info[$i]['deviceimei'][0];
			...
			//	$out = QueryToAirwatchAPI("DEVICE", $buscarwatch); //MXRNU19802100085}
				...
				echo '<table class="table table-hover">';
				echo '<thead class="encabezado"><tr><td>Grupo organizativo</td><td>Nombre descriptivo del dispositivo</td><td>MAC</td><td>Ultima vez visto</td><td>Ultima inscripcion</td></tr></thead>';
				echo '<tbody><tr><td>' . $array["LocationGroupName"] . '</td>';
