...
echo "<strong>Este Reporte busca todos celulares en LDAP que tengan deviceoffice diferente a BAJA_CEL* y busca el valor de LastSeen en Airwatch<br></strong>";
...
foreach ($imeis as &$value) {
	if (strlen($celdap[$value]['devicetag']) > 1) {
		...
		$eq="DUNNO";
		$oarray='';
		print "TAG:".$celdap[$value]['devicetag']." -> Imei (LDAP): ".$value." -> ";
